...
/**
 * Command to create an audit log. ActorType/Severity are strings here to keep API stable for callers.
 */
public record CreateAuditlogCmd(
        @NotNull UUID actorRef,
        @NotNull ActorType actorType,
        @NotNull Severity severity,
        @NotBlank @NotNull String originSystem,
        @NotBlank @NotNull String originService,
        @NotBlank @NotNull String originComponent,
        @NotBlank @NotNull String data,
        String description
) {}

/* should handle message sources! 
