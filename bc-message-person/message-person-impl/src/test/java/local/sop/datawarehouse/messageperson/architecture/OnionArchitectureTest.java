package local.sop.datawarehouse.messageperson.architecture;
...
@AnalyzeClasses(packages = {"local.sop.datawarehouse.messageperson", "local.sop.common.libs.sharedkernel", "local.sop.common.libs.infrastructure"},
importOptions = {
