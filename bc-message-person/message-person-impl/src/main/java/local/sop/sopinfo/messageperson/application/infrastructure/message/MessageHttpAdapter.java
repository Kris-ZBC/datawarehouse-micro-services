package local.sop.sopinfo.messageperson.application.infrastructure.message;
...
import local.sop.sopinfo.messageperson.application.infrastructure.ports.out.message.MessagePort;
