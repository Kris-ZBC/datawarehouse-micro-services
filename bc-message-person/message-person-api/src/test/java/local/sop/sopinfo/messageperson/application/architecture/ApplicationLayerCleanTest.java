package local.sop.sopinfo.messageperson.application.architecture;
...
@AnalyzeClasses(packages = {"local.sop.sopinfo.messageperson", "local.sop.sopinfo.sharedkernel" },
    importOptions = {
