package local.sop.datawarehouse.education.saga.application.infrastructure.auditlog;
...
import local.sop.datawarehouse.education.saga.application.api.dto.ResponseAuditlog;
import local.sop.datawarehouse.education.saga.application.infrastructure.request.PayloadAuditlogCreate;
...
public class AuditlogHttpAdapterTest {
	...
	void auditlog_compensate_shouldReturnResultFromDownstream() {
		...
		PayloadCreateCompensate request = new PayloadCreateCompensate(id, AuditlogHttpAdapter.class, state);
