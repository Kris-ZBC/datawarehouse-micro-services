package local.sop.datawarehouse.apprentice.architecture;
...
@AnalyzeClasses(packages = {"local.sop.datawarehouse.apprentice", "local.sop.common.libs.sharedkernel", "local.sop.common.libs.infrastructure"},
importOptions = {
...
public class OnionArchitectureTest {
    ...
    void hexagonal_architecture(JavaClasses importedClasses) {
            onionArchitecture()
                ...
                .because("The Apprentice BC must follow the Hexagonal Architecture pattern.")
