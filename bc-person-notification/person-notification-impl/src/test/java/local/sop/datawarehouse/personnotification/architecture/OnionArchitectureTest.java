package local.sop.datawarehouse.personnotification.architecture;
...
@AnalyzeClasses(packages = {"local.sop.datawarehouse.personnotification", "local.sop.common.libs.sharedkernel", "local.sop.common.libs.infrastructure"},
importOptions = {
