package local.sop.datawarehouse.sopinstructor.application.infrastructure.instructor;
...
import local.sop.datawarehouse.sopinstructor.application.infrastructure.ports.out.instructor.InstructorPort;
import local.sop.datawarehouse.sopinstructor.application.infrastructure.response.InstructorResponse;
