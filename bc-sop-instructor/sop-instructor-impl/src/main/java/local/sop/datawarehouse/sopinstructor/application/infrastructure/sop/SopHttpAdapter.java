package local.sop.datawarehouse.sopinstructor.application.infrastructure.sop;
...
import local.sop.datawarehouse.sopinstructor.application.infrastructure.ports.out.sop.SopPort;
