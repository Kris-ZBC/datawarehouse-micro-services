package local.sop.sopinfo.sopinstructor.architecture;
...
@AnalyzeClasses(packages = {"local.sop.sopinfo.sopinstructor", "local.sop.common.libs.sharedkernel", "local.sop.common.libs.infrastructure"},
importOptions = {
...
public class OnionArchitectureTest {
    ...
    void hexagonal_architecture(JavaClasses importedClasses) {
            onionArchitecture()
                ...
                .because("The Sop-Instructor BC must follow the Hexagonal Architecture pattern.")
