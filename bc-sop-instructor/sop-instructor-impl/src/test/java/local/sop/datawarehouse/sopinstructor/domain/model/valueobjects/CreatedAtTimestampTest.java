...
public class CreatedAtTimestampTest {
    ...
    void should_throw_exception_when_createdAt_is_null() {
        ...
        assertEquals("sop-instructor.createdate.required", exception.getMessage());
    }
    ...
    void should_throw_exception_when_createdAt_is_in_future() {
        ...
        assertEquals("sop-instructor.createdate.isafter", exception.getMessage());
    }
    ...
    void shouldThrow_whenValueIsNull() {
        ...
        assertEquals("sop-instructor.createdate.required", ex.getMessage());
    }
    ...
    void shouldThrow_whenValueIsInFuture() {
        ...
        assertEquals("sop-instructor.createdate.isafter", ex.getMessage());
    }
