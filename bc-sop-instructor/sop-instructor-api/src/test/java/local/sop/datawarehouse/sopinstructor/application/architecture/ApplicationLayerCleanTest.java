package local.sop.datawarehouse.sopinstructor.application.architecture;
...
@AnalyzeClasses(packages = {"local.sop.datawarehouse.sopinstructor", "local.sop.common.libs.sharedkernel" },
    importOptions = {
