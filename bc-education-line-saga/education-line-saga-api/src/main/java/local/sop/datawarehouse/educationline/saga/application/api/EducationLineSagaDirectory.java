package local.sop.datawarehouse.educationline.saga.application.api;

import java.util.UUID;

import local.sop.datawarehouse.educationline.saga.application.api.dto.CreateAuditlogCmd;
import local.sop.datawarehouse.educationline.saga.application.api.dto.CreateEducationLineCmd;
import local.sop.datawarehouse.educationline.saga.application.api.dto.EducationLineResponse;
import local.sop.datawarehouse.educationline.saga.application.api.dto.UpdateEducationLineDurationCmd;
import local.sop.datawarehouse.educationline.saga.application.api.dto.UpdateEducationLineNameCmd;
