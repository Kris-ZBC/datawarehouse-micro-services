package local.sop.datawarehouse.educationline.saga.application.infrastructure.educationline;
...
import local.sop.datawarehouse.educationline.saga.application.infrastructure.request.PayloadCompensate;
import local.sop.datawarehouse.educationline.saga.application.infrastructure.request.PayloadCompensateDuration;
import local.sop.datawarehouse.educationline.saga.application.infrastructure.request.PayloadCompensateName;
import local.sop.datawarehouse.educationline.saga.application.infrastructure.request.PayloadEducationLineCreate;
import local.sop.datawarehouse.educationline.saga.application.infrastructure.request.PayloadEducationLineDurationUpdate;
import local.sop.datawarehouse.educationline.saga.application.infrastructure.request.PayloadEducationLineNameUpdate;
import local.sop.datawarehouse.educationline.saga.application.infrastructure.response.ResponseCompensated;
import local.sop.datawarehouse.educationline.saga.application.ports.out.educationline.EducationLinePort;
