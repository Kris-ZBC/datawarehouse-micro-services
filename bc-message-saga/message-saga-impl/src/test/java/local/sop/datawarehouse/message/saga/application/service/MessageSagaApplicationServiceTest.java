package local.sop.datawarehouse.message.saga.application.service;
...
import local.sop.datawarehouse.message.saga.application.ports.out.apprentice.ApprenticePort;
import local.sop.datawarehouse.message.saga.application.ports.out.auditlog.AuditLogPort;
...
import local.sop.datawarehouse.message.saga.application.ports.out.instructor.InstructorPort;
import local.sop.datawarehouse.message.saga.application.ports.out.message.MessagePort;
...
import local.sop.datawarehouse.message.saga.application.ports.out.person.PersonPort;
import local.sop.datawarehouse.message.saga.application.ports.out.personnotification.PersonNotificationPort;
import local.sop.datawarehouse.message.saga.application.ports.out.saga.MessageSagaStatePort;
