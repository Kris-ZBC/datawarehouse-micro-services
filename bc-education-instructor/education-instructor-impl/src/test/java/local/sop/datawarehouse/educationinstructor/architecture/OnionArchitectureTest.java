package local.sop.datawarehouse.educationinstructor.architecture;
...
@AnalyzeClasses(
    packages = {"local.sop.datawarehouse.educationinstructor", "local.sop.common.libs.sharedkernel", "local.sop.common.libs.infrastructure"},
