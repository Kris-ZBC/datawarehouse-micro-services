...
public class EIRepositoryAdapter implements EducationInstructorRepositoryPort {

    private final EISpringDataRepository repository;
    private final EIJpaMapper mapper;
	private static final Logger log = LoggerFactory.getLogger(EIRepositoryAdapter.class);

    public EIRepositoryAdapter(EISpringDataRepository repository,EIJpaMapper mapper) {
    ...
    public Optional<EducationInstructor> findById(CompositeKey id) {
        EIId educationInstructorId = new EIId(id.key1(), id.key2());
    ...
    public EducationInstructor save(EducationInstructor e) {
        EIEntity entity = mapper.toEntity(e);
    ...
    public void update(EducationInstructor e) {
        ...
        EIEntity entity = mapper.toEntity(existing);
