package local.sop.sopinfo.educationinstructor.application.infrastructure.instructor;
...
import local.sop.sopinfo.educationinstructor.application.infrastructure.ports.out.instructor.InstructorPort;
...
public class InstructorHttpAdapter implements InstructorPort {
    ...
    private final Logger log = LoggerFactory.getLogger(InstructorHttpAdapter.class);
