package local.sop.datawarehouse.educationinstructor.application.architecture;
...
@AnalyzeClasses(packages = {"local.sop.datawarehouse.educationinstructor", "local.sop.common.libs.sharedkernel" },
    importOptions = {
