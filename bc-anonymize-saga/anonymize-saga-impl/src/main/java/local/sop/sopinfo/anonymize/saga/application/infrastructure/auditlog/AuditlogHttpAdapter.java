package local.sop.sopinfo.anonymize.saga.application.infrastructure.auditlog;
...
import local.sop.sopinfo.anonymize.saga.application.api.dto.ResponseAuditlog;
import local.sop.sopinfo.anonymize.saga.application.infrastructure.request.PayloadAuditlogCreate;
