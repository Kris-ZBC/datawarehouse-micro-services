package local.sop.sopinfo.consent.saga.application.infrastructure;
...
import local.sop.sopinfo.consent.saga.application.infrastructure.auditlog.AuditlogHttpAdapter;
