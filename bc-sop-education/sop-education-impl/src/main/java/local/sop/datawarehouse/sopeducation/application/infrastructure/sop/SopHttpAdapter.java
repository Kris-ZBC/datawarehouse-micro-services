package local.sop.datawarehouse.sopeducation.application.infrastructure.sop;
...
import local.sop.datawarehouse.sopeducation.application.infrastructure.ports.out.sop.SopPort;
import local.sop.datawarehouse.sopeducation.application.infrastructure.response.SopResponse;
